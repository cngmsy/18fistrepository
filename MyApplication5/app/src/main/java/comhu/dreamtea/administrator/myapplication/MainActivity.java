...
import comhu.dreamtea.administrator.myapplication.coustom.ImageProcessing;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initConfig() {
        ...
        int style = PointStyle.CIRCLE;
        renderer = buildRenderer(color, style, true);
        //设置好图表的样式
        setChartSettings(renderer, "X", "Y", 0, 300, 4, 16, Color.BLUE, Color.YELLOW);
        ...
        //这里的Handler实例将配合下面的Timer实例，完成定时更新图表的功7UJM能
        handler = new Handler() {
            @Override
     ...
     * @return
     */
    protected XYMultipleSeriesRenderer buildRenderer(int color, int style, boolean fill) {
